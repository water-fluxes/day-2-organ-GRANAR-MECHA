---
title: "Hands-on session: GRANAR – Generator of root anatomies in R"
...
```
Explore more detailed anatomies using a parameter set with additional features.
```{r}
...
params_sem <- read_param_xml(path = "./www/root_monocot_simpl.xml")
